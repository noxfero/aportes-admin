    ...
    public function editarAporte(){  
        if(isset($_POST["valueE"]) && isset($_POST["bankE"]) && isset($_POST["accountE"]))
        {
            ...
            )
            {
                ...
                if ($save == TRUE)
                    {
                        $aporte->phpAlert("Aporte actualizado con éxito",$this->baseUrl("BandejaBancos", "index")); // Alerta y redirige
                    }
                    else
                    {
                        $aporte->phpAlert("Error con la actualización. Interente nuevamente",$this->baseUrl("BandejaBancos", "index")); // Alerta y redirige
            ...
            else
                {
                    ...
                    $aportex->phpAlert("Complete todos los campos para almacenar.",$this->baseUrl("BandejaBancos", "index")); // Alerta y redirige
                }
        }   
        else
        {
